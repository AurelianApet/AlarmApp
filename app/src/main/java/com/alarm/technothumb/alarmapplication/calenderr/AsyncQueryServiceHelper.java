...
public class AsyncQueryServiceHelper extends IntentService {
    ...
    static public AsyncQueryService.Operation getLastCancelableOperation() {
        ...
        if (AsyncQueryService.localLOGV) {
            Log.d(TAG, "getLastCancelableOperation -> Operation:" + AsyncQueryService.Operation.opToChar(op.op)
                    + " token:" + op.token);
        }
        return op;
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (resolver != null) {
            ...
            if (AsyncQueryService.localLOGV) {
                Log.d(TAG, "onHandleIntent: op=" + AsyncQueryService.Operation.opToChar(args.op) + ", token="
                        + reply.what);
            }
