...
import com.alarm.technothumb.alarmapplication.calenderr.widget.CompositeCursorAdapter;
...
public abstract class BaseEmailAddressAdapter extends CompositeCursorAdapter implements Filterable {
    ...
    private final class DefaultPartitionFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (!TextUtils.isEmpty(constraint)) {
                Uri.Builder builder = ContactsContract.CommonDataKinds.Email.CONTENT_FILTER_URI.buildUpon()
    ...
    private final class DirectoryPartitionFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            FilterResults results = new FilterResults();
            if (!TextUtils.isEmpty(constraint)) {
                Uri uri = ContactsContract.CommonDataKinds.Email.CONTENT_FILTER_URI.buildUpon()
                        .appendPath(constraint.toString())
