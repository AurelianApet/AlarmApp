package com.alarm.technothumb.alarmapplication.alarmm.stopwatch;
...
import com.alarm.technothumb.alarmapplication.alarmm.timer.CountingTimerView;
...
public class StopwatchFragment extends DeskClockFragment
    ...
    private void showSharePopup() {
        ...
        mSharePopup.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
