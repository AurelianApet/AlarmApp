...
public class CalendarColorPickerDialog extends ColorPickerDialog {
    ...
    static final String COLORS_WHERE = CalendarContract.Colors.ACCOUNT_NAME + "=? AND " + CalendarContract.Colors.ACCOUNT_TYPE +
            "=? AND " + CalendarContract.Colors.COLOR_TYPE + "=" + CalendarContract.Colors.TYPE_CALENDAR;
    ...
    private void startQuery() {
        if (mService != null) {
            ...
            mService.startQuery(TOKEN_QUERY_CALENDARS, null,
                    ContentUris.withAppendedId(CalendarContract.Calendars.CONTENT_URI, mCalendarId),
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            ...
            switch (token) {
                case TOKEN_QUERY_CALENDARS:
                    ...
                    @SuppressLint("NewApi") Uri uri = CalendarContract.Colors.CONTENT_URI;
    ...
    private class OnCalendarColorSelectedListener implements ColorPickerSwatch.OnColorSelectedListener {
        ...
        public void onColorSelected(int color) {
            ...
            values.put(CalendarContract.Calendars.CALENDAR_COLOR_KEY, mColorKeyMap.get(color));
            mService.startUpdate(mService.getNextToken(), null, ContentUris.withAppendedId(
                    CalendarContract.Calendars.CONTENT_URI, mCalendarId), values, null, null, Utils.UNDO_DELAY);
        }
    }
}
