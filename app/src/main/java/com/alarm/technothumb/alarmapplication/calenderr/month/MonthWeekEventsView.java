package com.alarm.technothumb.alarmapplication.calenderr.month;
...
import com.alarm.technothumb.alarmapplication.calenderr.Event;
...
public class MonthWeekEventsView extends SimpleWeekView {
    ...
    protected void initView() {
        ...
        mMonthNumPaint.setTextAlign(Paint.Align.RIGHT);
        ...
        mEventExtrasPaint.setStyle(Paint.Style.FILL);
        mEventExtrasPaint.setTextAlign(Paint.Align.LEFT);
        ...
        mEventDeclinedExtrasPaint.setStyle(Paint.Style.FILL);
        mEventDeclinedExtrasPaint.setTextAlign(Paint.Align.LEFT);
        ...
        mWeekNumPaint.setStyle(Paint.Style.FILL);
        mWeekNumPaint.setTextAlign(Paint.Align.RIGHT);
        ...
        mDNATimePaint.setStyle(Paint.Style.FILL_AND_STROKE);
        ...
        mDNAAllDayPaint.setStyle(Paint.Style.FILL_AND_STROKE);
        mDNAAllDayPaint.setStrokeWidth(DNA_ALL_DAY_WIDTH);
    ...
    protected int drawEvent(Canvas canvas, Event event, int x, int y, int rightEdge,
        ...
        boolean isDeclined = event.selfAttendeeStatus == CalendarContract.Attendees.ATTENDEE_STATUS_DECLINED;
        ...
        if (event.selfAttendeeStatus != CalendarContract.Attendees.ATTENDEE_STATUS_INVITED) {
