...
import com.alarm.technothumb.alarmapplication.alarmm.provider.DaysOfWeek;
import com.alarm.technothumb.alarmapplication.alarmm.widget.ActionableToastBar;
import com.alarm.technothumb.alarmapplication.alarmm.widget.TextTime;
...
public class AlarmClockFragment extends DeskClockFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mFadeIn.addListener(new Animator.AnimatorListener() {
...
//            showUndoBar();
    ...
    public class AlarmItemAdapter extends CursorAdapter {
        ...
        public AlarmItemAdapter(Context context, long[] expandedIds, long[] repeatCheckedIds,
            ...
            mBackgroundColor = R.drawable.back_cal;
        ...
        private void setNewHolder(View view) {
            ...
            holder.footerFiller.setOnClickListener(new View.OnClickListener() {
