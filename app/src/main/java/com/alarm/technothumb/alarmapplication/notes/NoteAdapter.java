...
import static com.alarm.technothumb.alarmapplication.notes.NotesFragment.deleteActive;
import static com.alarm.technothumb.alarmapplication.notes.NotesFragment.searchActive;
import static com.alarm.technothumb.alarmapplication.notes.NotesFragment.setFavourite;
...
public class NoteAdapter extends BaseAdapter implements ListAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (noteObject != null) {
            ...
            if (NotesFragment.checkedArray.contains(position)) {
