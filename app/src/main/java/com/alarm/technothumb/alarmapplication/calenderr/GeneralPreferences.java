...
import com.alarm.technothumb.alarmapplication.calenderr.alerts.AlertReceiver;
...
public class GeneralPreferences extends PreferenceFragment implements
        SharedPreferences.OnSharedPreferenceChangeListener, Preference.OnPreferenceChangeListener, TimeZonePickerDialog.OnTimeZoneSetListener {
    // Preference keys
    ...
    public void onCreate(Bundle icicle) {
        ...
        final SharedPreferences.Editor editor = preferenceScreen.getEditor();
        ...
        mHomeTZ.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mUseHomeTZ) {
            if ((Boolean)newValue) {
                ...
                tz = CalendarContract.CalendarCache.TIMEZONE_TYPE_AUTO;
            }
