...
public class AlertReceiver extends BroadcastReceiver {
    ...
    private static final String[] EVENT_PROJECTION = new String[]{
            CalendarContract.Calendars.OWNER_ACCOUNT, // 0
    ...
    public static AlertService.NotificationWrapper makeBasicNotification(Context context, String title,
...
//                context, 11111, notifIntent, PendingIntent.FLAG_CANCEL_CURRENT
//        );
     ...
     */
    public static AlertService.NotificationWrapper makeExpandingNotification(Context context, String title,
        ...
        return new AlertService.NotificationWrapper(notification, notificationId, eventId, startMillis,
                endMillis, doPopup);
    }
     ...
     */
    public static AlertService.NotificationWrapper makeDigestNotification(Context context,
        ...
        if (AlertService.DEBUG) {
            for (AlertService.NotificationInfo info : notificationInfos) {
                nw.add(new AlertService.NotificationWrapper(null, 0, info.eventId, info.startMillis,
