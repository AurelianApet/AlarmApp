package com.alarm.technothumb.alarmapplication.calenderr.contacts;
...
public class DataUsageStatUpdater {
    ...
    public static final class DataUsageFeedback {
        static final Uri FEEDBACK_URI =
                Uri.withAppendedPath(ContactsContract.Data.CONTENT_URI, "usagefeedback");
    ...
    public boolean updateWithAddress(Collection<String> addresses) {
        ...
        if (addresses != null && !addresses.isEmpty()) {
            ...
            whereBuilder.append(ContactsContract.CommonDataKinds.Email.DATA1 + " IN (")
                    .append(TextUtils.join(",", questionMarks))
                    .append(")");
            final Cursor cursor = mResolver.query(ContactsContract.CommonDataKinds.Email.CONTENT_URI,
                    new String[] {ContactsContract.CommonDataKinds.Email.CONTACT_ID, ContactsContract.CommonDataKinds.Email._ID}, whereBuilder.toString(),
    ...
    public boolean updateWithPhoneNumber(Collection<String> numbers) {
        ...
        if (numbers != null && !numbers.isEmpty()) {
            ...
            whereBuilder.append(ContactsContract.CommonDataKinds.Phone.DATA1 + " IN (")
                    .append(TextUtils.join(",", questionMarks))
                    .append(")");
            final Cursor cursor = mResolver.query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI,
                    new String[] {ContactsContract.CommonDataKinds.Phone.CONTACT_ID, ContactsContract.CommonDataKinds.Phone._ID}, whereBuilder.toString(),
                    whereArgs.toArray(new String[0]), null);
