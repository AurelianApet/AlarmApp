...
public class EventViewUtils {
     ...
     */
    public static ArrayList<CalendarEventModel.ReminderEntry> reminderItemsToReminders(
        ...
        ArrayList<CalendarEventModel.ReminderEntry> reminders = new ArrayList<CalendarEventModel.ReminderEntry>(len);
    ...
    public static boolean addReminder(Activity activity, View view, View.OnClickListener listener,
                                      ...
                                      ArrayList<String> methodLabels, CalendarEventModel.ReminderEntry newReminder, int maxReminders,
