...
public class CalenderFragmentt extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View v = inflater.inflate(R.layout.fragment_calenderr, container, false);
        ...
        txt_calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i =new Intent(getActivity(),CalenderrActivity.class);
