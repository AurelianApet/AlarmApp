...
public class CalendarAppWidgetService extends RemoteViewsService {
    ...
    private static final String EVENT_SORT_ORDER = CalendarContract.Instances.START_DAY + " ASC, "
    ...
    private static final String EVENT_SELECTION = CalendarContract.Calendars.VISIBLE + "=1";
    private static final String EVENT_SELECTION_HIDE_DECLINED = CalendarContract.Calendars.VISIBLE + "=1 AND "
