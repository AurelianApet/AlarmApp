...
import com.alarm.technothumb.alarmapplication.calenderr.CalendarColorPickerDialog;
...
public class SelectSyncedCalendarsMultiAccountAdapter extends CursorTreeAdapter implements
        View.OnClickListener, CalendarColorCache.OnCalendarColorsLoadedListener {
    ...
    private static final String ACCOUNT_SELECTION = CalendarContract.Calendars.ACCOUNT_NAME + "=?"
    ...
    public void doSaveAction() {
        ...
        while (changeKeys.hasNext()) {
            ...
            values.put(CalendarContract.Calendars.VISIBLE, newSynced ? 1 : 0);
            values.put(CalendarContract.Calendars.SYNC_EVENTS, newSynced ? 1 : 0);
    ...
    protected void bindGroupView(View view, Context context, Cursor cursor, boolean isExpanded) {
        int accountColumn = cursor.getColumnIndexOrThrow(CalendarContract.Calendars.ACCOUNT_NAME);
        int accountTypeColumn = cursor.getColumnIndexOrThrow(CalendarContract.Calendars.ACCOUNT_TYPE);
    ...
    protected Cursor getChildrenCursor(Cursor groupCursor) {
        int accountColumn = groupCursor.getColumnIndexOrThrow(CalendarContract.Calendars.ACCOUNT_NAME);
        int accountTypeColumn = groupCursor.getColumnIndexOrThrow(CalendarContract.Calendars.ACCOUNT_TYPE);
