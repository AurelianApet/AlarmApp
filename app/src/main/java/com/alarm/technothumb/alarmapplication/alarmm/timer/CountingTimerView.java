...
public class CountingTimerView extends View {
    ...
    public void setTime(long time, boolean showHundredths, boolean update) {
        ...
        if (hours == 0 && minutes == 0 && seconds == 0) {
            showNeg = false;
            //android.util.Log.e("Neg", showNeg + "");
        }
     ...
     * {@link com.alarm.technothumb.alarmapplication.alarmm.CircleTimerView#onDraw(android.graphics.Canvas)}
     */
    ...
    public String getTimeString() {
        ...
        if (mHundredths == null) {
            ...
            return String.format("0:%s:%s.%s", mMinutes, mSeconds, mHundredths);
        }
    ...
    private static String getTimeStringForAccessibility(int hours, int minutes, int seconds,
       ...
       // android.util.Log.e("showNeg1111", showNeg + "");

     /*   if (showNeg) {
            // This must be followed by a non-zero number or it will be audible as "hyphen"
            // instead of "minus".
            //s.append("-");\\\
            android.util.Log.e("showNeg", showNeg + "");

            s.append(String.format(
                    r.getQuantityText(R.plurals.Nminutes_description, 00).toString(),
                    00));
            s.append(" ");
            s.append(String.format(
                    r.getQuantityText(R.plurals.Nseconds_description, 00).toString(),
                    00));
        } else*/ if (showNeg && hours == 0 && minutes == 0) {
