...
public class Event implements Cloneable {
    ...
    static {
        if (!Utils.isJellybeanOrLater()) {
            EVENT_PROJECTION[PROJECTION_COLOR_INDEX] = CalendarContract.Instances.CALENDAR_COLOR;
        }
    }
    ...
    public static final Event newInstance() {
        ...
        e.hasAlarm = false;
        e.isRepeating = false;
        e.selfAttendeeStatus = CalendarContract.Attendees.ATTENDEE_STATUS_NONE;
    ...
    public static void loadEvents(Context context, ArrayList<Event> events, int startDay, int days,
        ...
        try {
            ...
            if (hideDeclined) {
                String hideString = " AND " + CalendarContract.Instances.SELF_ATTENDEE_STATUS + "!="
