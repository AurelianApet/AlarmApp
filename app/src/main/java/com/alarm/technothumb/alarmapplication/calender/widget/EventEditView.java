...
import com.alarm.technothumb.alarmapplication.calender.ViewUtils;
...
//    private final TextInputLayout mTextInputTitle1;
    private final EditText mEditTextTitle;
    private LinearLayout ll_anniversary;
//    private Button btn_add;
//    EditText et_anniversary;

//    private final EditText mEditTextTitle1;
...
//        mTextInputTitle1 = (TextInputLayout) findViewById(R.id.text_input_title1);
        mEditTextTitle = (EditText) findViewById(R.id.edit_text_title);
//        mEditTextTitle1 = (EditText) findViewById(R.id.edit_text_title1);
...
//        et_anniversary = (EditText)findViewById(R.id.et_anniversary);
       ...
       /* SharedPreferences myPrefs = context.getSharedPreferences("myPrefs", MODE_PRIVATE);
        String  myString = myPrefs.getString("name","nothing");
        Log.e("name1",myString);
        mEditTextTitle.setText(myString);
*/
//        btn_add.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//
//                String anniversary = et_anniversary.getText().toString();
//
//                stringlist.add(anniversary);
...
//        });
        ...
        //spinner click event editText.setText(spinner.getSelectedItem().toString());
    }
     ...
     */
    public void setEvent(@NonNull final Event event) {
        mEvent = event;
...
//                String abc = spinner1.getSelectedItem().toString();
                ...
                mEditTextTitle.setHint(plants[position]);
            }
