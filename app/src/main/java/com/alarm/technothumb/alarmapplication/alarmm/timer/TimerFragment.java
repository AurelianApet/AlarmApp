...
import com.alarm.technothumb.alarmapplication.alarmm.DeskClockFragment;
import com.alarm.technothumb.alarmapplication.alarmm.LabelDialogFragment;
import com.alarm.technothumb.alarmapplication.alarmm.TimerSetupView;
import com.alarm.technothumb.alarmapplication.alarmm.Utils;
import com.alarm.technothumb.alarmapplication.alarmm.widget.sgv.GridAdapter;
import com.alarm.technothumb.alarmapplication.alarmm.widget.sgv.SgvAnimationHelper;
import com.alarm.technothumb.alarmapplication.alarmm.widget.sgv.StaggeredGridView;
...
public class TimerFragment extends DeskClockFragment
    ...
    public static final String GOTO_SETUP_VIEW = "LightUpDroid.timers.gotosetup";
    ...
    class TimersListAdapter extends GridAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (o.mState == TimerObj.STATE_TIMESUP) {
                getItem(position).mState = TimerObj.STATE_DONE;
                // Log.e("!!!", "111");
            }
            //Log.e("22", "222" + o.mState);
            ...
            switch (o.mState) {
                case TimerObj.STATE_RUNNING:
                    v.start();
                    RepeatAlarmUtils utils = new RepeatAlarmUtils(getActivity());
                    utils.setRepeatAlarm(System.currentTimeMillis() + 800 * 1);
                    break;
...
/*
            ...
            for (int i = 0; i < mTimers.size(); i++) {
                ...
                if (t.mState == TimerObj.STATE_RUNNING || t.mState == TimerObj.STATE_TIMESUP) {
                    long timeLeft = t.mTimeLeft;
                    if (t.mView != null) {
                        if (timeLeft <= 0) {
                            timeLeft = 00;
                        }
                        android.util.Log.e("FRAGMENT TL:", timeLeft + "");
         ...
         /*  SharedPreferences mPrefsTemp = PreferenceManager.getDefaultSharedPreferences(context);
            TimerObj.getTimersFromSharedPrefs(mPrefs, mTimers);
...
*/
                ...
                if (toggle && t.mView != null) {
                    if (t.mState == TimerObj.STATE_TIMESUP) {
                        ...
                        if (counterIsActive == false) {
                            MediaPlayer mplayer = MediaPlayer.create(getActivity(), R.raw.airhorn);
                            mplayer.start();
                            // Log.e("song", "song");
                        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAddTimer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mTimerSetup.reset();
                gotoSetupView();
  ...
  /*      if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            getActivity().startForegroundService(new Intent(getActivity(), TimerBackService.class));
        } else {
            getActivity().startService(new Intent(getActivity(), TimerBackService.class));
        }
*/
        mTimersList.postDelayed(mClockTick, 20);
        mTicking = true;
...
//public class TimerFragment extends DeskClockFragment implements View.OnClickListener {
//
