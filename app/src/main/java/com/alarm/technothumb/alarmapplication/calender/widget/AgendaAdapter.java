...
import com.alarm.technothumb.alarmapplication.calender.EditActivity;
...
//        myString = myPrefs.getString("Value","nothing");
//        Log.e("value1",myString);
    }
...
//                    SharedPreferences myPrefs = v.getContext().getSharedPreferences("myPrefs", MODE_PRIVATE);
//                    SharedPreferences.Editor prefsEditor = myPrefs.edit();
//                    prefsEditor.putString("name",item.mTitle);
//
//                    prefsEditor.commit();
//                    Log.e("value", plants[position]);




//                    Intent i = new Intent(v.getContext(),EditActivity.class);
//                    i.putExtra("name",item.mTitle);
//                    Log.e("name",item.mTitle);
...
//        final View weather;
        ...
        public GroupViewHolder(View itemView) {
            ...
            textView1 = (TextView) itemView.findViewById(R.id.text_view_title1);
...
//            textViewNight = (TextView) itemView.findViewById(R.id.text_view_night);
    ...
    static class ContentViewHolder extends RowViewHolder {
        ...
        final TextView textViewTitle,textViewTitle1;
        ...
        public ContentViewHolder(View itemView) {
            ...
            textViewTitle1 = (TextView) itemView.findViewById(R.id.text_view_title1);
            textViewTime = (TextView) itemView.findViewById(R.id.text_view_time);
            background = itemView.findViewById(R.id.background);

//            textViewTitle1.setText(myString);
