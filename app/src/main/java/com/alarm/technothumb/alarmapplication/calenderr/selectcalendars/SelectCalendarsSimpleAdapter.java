...
public class SelectCalendarsSimpleAdapter extends BaseAdapter implements ListAdapter,
    ...
    private void initData(Cursor c) {
        ...
        mVisibleColumn = c.getColumnIndexOrThrow(CalendarContract.Calendars.VISIBLE);
        mOwnerAccountColumn = c.getColumnIndexOrThrow(CalendarContract.Calendars.OWNER_ACCOUNT);
