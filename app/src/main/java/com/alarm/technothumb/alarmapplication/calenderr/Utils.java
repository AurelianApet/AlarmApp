...
public class Utils {
    ...
    public static int getViewTypeFromIntentAndSharedPref(Activity activity) {
        ...
        if (TextUtils.equals(intent.getAction(), Intent.ACTION_EDIT)) {
            return CalendarController.ViewType.EDIT;
        }
        if (extras != null) {
            if (extras.getBoolean(INTENT_KEY_DETAIL_VIEW, false)) {
                ...
                return CalendarController.ViewType.DAY;
            }
        }
    ...
    public static void returnToCalendarHome(Context context) {
            Intent launchIntent = new Intent(context, CalenderrActivity.class);
    ...
    public static ArrayList<CalendarEventModel.ReminderEntry> readRemindersFromBundle(Bundle bundle) {
        ...
        if (numReminders == reminderMethods.size()) {
            ...
            reminders = new ArrayList<CalendarEventModel.ReminderEntry>(numReminders);
