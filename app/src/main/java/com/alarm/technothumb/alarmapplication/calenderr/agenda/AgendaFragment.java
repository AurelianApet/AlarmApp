...
import static com.alarm.technothumb.alarmapplication.calenderr.CalendarController.EXTRA_GOTO_TODAY;
import static com.alarm.technothumb.alarmapplication.calenderr.CalendarController.getInstance;
...
public class AgendaFragment extends Fragment implements CalendarController.EventHandler,
    ...
    private CalendarController.EventInfo mOnAttachedInfo = null;
...
//        Utils.setDefaultView(this, CalendarApplication.AGENDA_VIEW_ID);
    ...
    public long getSupportedEventTypes() {
        return CalendarController.EventType.GO_TO | CalendarController.EventType.EVENTS_CHANGED | ((mUsedForSearch)? CalendarController.EventType.SEARCH:0);
    }
    ...
    public void handleEvent(CalendarController.EventInfo event) {
        if (event.eventType == CalendarController.EventType.GO_TO) {
            ...
            goTo(event, true);
        } else if (event.eventType == CalendarController.EventType.SEARCH) {
        ...
        if (mShowEventDetailsWithAgenda) {
            ...
            if (fOld == null || replaceFragment || fOld.getStartMillis() != startMillis ||
                ...
                mEventFragment = new EventInfoFragment(mActivity, event.id,
                        ...
                        CalendarContract.Attendees.ATTENDEE_STATUS_NONE, false,
            ...
            if (!mIsTabletConfig) {
                view.post(new Runnable() {
                    ...
                    public void run() {
                        Time t = new Time(mTimeZone);
                        t.setJulianDay(mJulianDayOnTop);
                        mController.sendEvent(this, CalendarController.EventType.UPDATE_TITLE, t, t, null, -1,
                                CalendarController.ViewType.CURRENT, 0, null, null);
                    }
                });
            }
        }
