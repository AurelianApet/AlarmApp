...
public class DbOpenHelperr extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "TravelRecordAudio";
    Context context;
    ...
    private static final String NOTES_TABLE_CREATE =
            "CREATE TABLE " + DbContract.NoteEntry.TABLE_NAME + " (" +
                    ...
                    DbContract.NoteEntry.LATI + " TEXT NOT NULL, " +
                    DbContract.NoteEntry.LONGI + " TEXT NOT NULL, " +
                    DbContract.NoteEntry.COUNTRY + " TEXT NOT NULL, " +
                    DbContract.NoteEntry.CITY + " TEXT NOT NULL, " +
                    DbContract.NoteEntry.STATE + " TEXT NOT NULL, " +
                    DbContract.NoteEntry.DATETIME + " TEXT NOT NULL, " +
...
//    DbContract.NoteEntry.LATITUDE + "INTEGER, " +
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO " + DbContract.CategoryEntry.TABLE_NAME + " (" + DbContract.CategoryEntry.COLUMN_NAME + ")" +
                " VALUES ('" + context.getString(R.string.default_category) + "');");
    }
