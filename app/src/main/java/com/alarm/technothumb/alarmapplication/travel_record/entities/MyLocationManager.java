...
public class MyLocationManager implements GoogleApiClient.ConnectionCallbacks {
    ...
    public void setLastKnownLocation() {
        ...
        @SuppressLint("MissingPermission") Location lastKnownGPS = getBetterLocationAux(mLocationManager
                .getLastKnownLocation(LocationManager.GPS_PROVIDER), mSatelliteLocation);
        @SuppressLint("MissingPermission") Location lastKnownNetwork = getBetterLocationAux(mLocationManager
