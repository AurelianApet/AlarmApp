package com.alarm.technothumb.alarmapplication.notes;
...
import static com.alarm.technothumb.alarmapplication.notes.DataUtils.BACKUP_FILE_NAME;
import static com.alarm.technothumb.alarmapplication.notes.DataUtils.BACKUP_FOLDER_PATH;
import static com.alarm.technothumb.alarmapplication.notes.DataUtils.NEW_NOTE_REQUEST;
import static com.alarm.technothumb.alarmapplication.notes.DataUtils.NOTES_FILE_NAME;
import static com.alarm.technothumb.alarmapplication.notes.DataUtils.NOTE_BODY;
import static com.alarm.technothumb.alarmapplication.notes.DataUtils.NOTE_COLOUR;
import static com.alarm.technothumb.alarmapplication.notes.DataUtils.NOTE_FAVOURED;
import static com.alarm.technothumb.alarmapplication.notes.DataUtils.NOTE_FONT_SIZE;
import static com.alarm.technothumb.alarmapplication.notes.DataUtils.NOTE_HIDE_BODY;
import static com.alarm.technothumb.alarmapplication.notes.DataUtils.NOTE_REQUEST_CODE;
import static com.alarm.technothumb.alarmapplication.notes.DataUtils.NOTE_TITLE;
import static com.alarm.technothumb.alarmapplication.notes.DataUtils.deleteNotes;
import static com.alarm.technothumb.alarmapplication.notes.DataUtils.isExternalStorageReadable;
import static com.alarm.technothumb.alarmapplication.notes.DataUtils.isExternalStorageWritable;
import static com.alarm.technothumb.alarmapplication.notes.DataUtils.retrieveData;
import static com.alarm.technothumb.alarmapplication.notes.DataUtils.saveData;

/**
 * Created by NIKUNJ on 25-01-2018.
 */
...
public class NotesFragment extends Fragment implements AdapterView.OnItemClickListener,
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        newNote = (ImageButton)v.findViewById(R.id.newNote);
        noNotes = (TextView)v.findViewById(R.id.noNotes);
    ...
    public boolean onCreateActionMode(ActionMode mode, Menu menu) {
        mode.getMenuInflater().inflate(R.menu.menu_notes_delete, menu); // Inflate 'menu_delete' menu
    ...
    public boolean onQueryTextChange(String s) {
        ...
        if (s.length() > 0) {
            ...
            NoteAdapter searchAdapter = new NoteAdapter(getActivity(), notesFound);
